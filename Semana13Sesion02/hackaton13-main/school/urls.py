...
urlpatterns = [
    ...
    path('marcar_asistencia/<str:id_profesor>/<str:id_alumno>',
         views.marcar_asistencia, name="marcar_asistencia"),
    ...
    # API
    path('api/notas/<str:alumno_id>/',
         views.NotasList.as_view(), name='api/notas'),
    path('calendario_asistencia/<str:alumno_id>/',
         views.AsistenciaList.as_view(), name='calendario_asistencia')
]
