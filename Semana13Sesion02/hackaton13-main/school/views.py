...
def dashboard(request, id_usuario):
    ...
    if rol.name != 'Profesor':
        ...
        encontrar_alumnos_matriculados = list(
            Matricula.objects.filter(teacher_id=id_usuario))
        for matriculados in encontrar_alumnos_matriculados:
            ...
            asistencia = Asistencia.objects.filter(
                student=matriculados.student_id, teacher=id_usuario, attendance=True, registration=date.today())
